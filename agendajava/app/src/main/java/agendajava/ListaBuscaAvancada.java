...
public class ListaBuscaAvancada extends JFrame {
    ...
    public ListaBuscaAvancada(List<AppointmentTask> compromissos) {
        ...
        setTitle("Resultado da pesquisa avançada");
    ...
    private void atualizarListaCompromissos() {
        ...
        for (int i = startIndex; i < endIndex; i++) {
            ...
            String itemFormatted = "<html><b>" + compromisso.getData() + "/" + compromisso.getHora() + "</b> : " + compromisso.getTitulo() + "</html>";
    ...
    private void abrirTelaDeEdicao(int compromissoId) {
        ...
        if (compromissoSelecionado != null) {
            ...
            EdicaoCompromissoDialog dialog = new EdicaoCompromissoDialog(compromissoSelecionado, data);
    ...
    public void recarregarCompromissos(String date) {
        //compromissosCompleto =  AppointmentTaskDAO.buscarCompromissos(dia,  mes,  ano,  hora,  titulo,  descricao,  categoria,  status);
        data = date;
        reiniciarTela();
    }
