...
public class FramePanel extends JFrame
{
  ...
  String [] meses = {"Janeiro","Fevereiro","Marco","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro"};//Array de meses
  String [] week = {"   Domingo","   Segunda","   Terça", "   Quarta","   Quinta","   Sexta","   Sabado"};//array for the days of the week
  //_________
  ...
  JButton newAppointment = new JButton("Consultar Compromissos");
   ...
   public void actionPerformed(ActionEvent event)
  {
     ...
     if(event.getSource() == label)//if the listener will be used for searching a random month
     {
      ...
      month = meses[sira];////gets the given month and turns it into a name
